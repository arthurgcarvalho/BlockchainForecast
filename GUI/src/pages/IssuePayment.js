...
class IssuePayment extends Component {
    ...
    issuePayment = async e => {
        ...
        try {
            ...
            const signedTx = await web3.eth.accounts.signTransaction({
                ...
                chainId: 3, //Ropsten
                nonce: nonceCount,
                data: contract.methods.issuePayment().encodeABI()
    ...
    render() {
        return (
            <div>
                <PageHeader className="header-container" title="Issue Payment" />
                <Input.Group compact className="container">
                    ...
                    <Input
                        ...
                        placeholder="Principal or Agent's Public Key"
                    ...
                    <Input
                        ...
                        placeholder="Principal or Agent's Private Key"
                        onChange={e => this.setState({ privateKey: e.target.value })}
                    />
                    <br /><br /><br />
                    <Button icon="dollar" type="primary" onClick={this.issuePayment} >
                        Issue
                    </Button>
                    <br />
                    <br />
